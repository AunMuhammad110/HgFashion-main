...
// }
const OrderForm = () => {
  // const { data, TotalCalculator, WeightCalculator, NumberofProduct } =
  //   useDataContext();
   const { data, TotalCalculator, NumberofProduct } =
    useDataContext();
  ...
  const IdandQuantity = () => {
    return data.map(({ _doc: { productId }, quantity }) => ({
      productId,
      quantity,
    }));
  };
  ...
  const saveOrderData = () => {
    axios
      .post("http://localhost:3334/addOrder", {
        ...
        PaymentSS: selectedFile,
        totalBill: TotalCalculator(),
        NoOfProduct: NumberofProduct(),
        productsInfo: IdandQuantity(),
  ...
  // below code is only for shipment related things
  // useEffect(() => {
  //   // Fetch the list of countries from the backend
  //   const fetchCountries = async () => {
  //     try {
  //       const response = await axios.get(
  //         "http://localhost:3334/fetchCountryDetails"
  //       );
  ...
  //   setTimeout(() => {
  //     const countryPrices = countries.find(
  //       (item) => item.countryName === selectedCountry
  //     );
  //     const { firstKg, addKg } = countryPrices;
  //     console.log(firstKg, addKg);
  //     const calculatedShipmentPrice =
  //       WeightCalculator() <= 1
  //         ? firstKg
  //         : firstKg + (WeightCalculator() - 1) * addKg;
                ...
                >
                  ...
                  <div className="row d-inline-block">
                    ...
                    >
                      ...
                      <span className="txt">Email me with news and update</span>
                    </label>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="input-group mb-2">
                      <input
                        ...
                        placeholder="House # 13 Street 21 A......"
                        aria-label="Recipient's username"
                        aria-describedby="basic-addon2"
                      />
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="input-group mb-2">
                      <input
                        ...
                        className={`form-control ${
                          errorMessages.PhoneNumber ? "error" : ""
                        }`}
                        required
                        aria-label="Recipient's username"
                        aria-describedby="basic-addon2"
                      ...
                      <div style={{ display: "inline-block" }}>
                        ...
                        <div className="d-flex justify-content-center">
                          ...
                          {errorMessages.selectedFile && (
                            <div className="error-message ml-2 d-flex align-items-center ">
                              {errorMessages.selectedFile}
                            </div>
                          )}
          ...
          />
                      ...
                      <div>
                        ...
                        >
                          ...
                          >
                            <b>Bank Name:</b> Meezan Bank Limited
                            <br />
                            <b>Account Title:</b> MISBAH FATIMA/SHEIKH MUHAMMAD
                            SIDDIQ <br />
                            ...
                            <b>Swift code:</b> <br />
                            Kindly attach the proof of payment below and if you
                            want to avail the services of stiching You may
                            contact us on whatsapp +92336912179
                          </p>
                        </div>
                      </div>
                    </div>
                        ...
                        >
                          ...
                          >
                            <p style={{ fontSize: "14px" }}>
                              {item._doc.brandName} {item._doc.productTitle}
                            </p>
                          </div>
                          <div
                            className="col-3"
                          ...
                          >
                            <div id="pos">
                              <span>Rs. {item._doc.productPrice}.00/-</span>
                            </div>
                          </div>
                          <br />
                        </div>
                    ...
                    >
                      ...
                      >
                        {shipmentTotal !== 0 ? (
                          ...
                          <span style={{ textAlign: "right", paddingLeft: 0 }}>
                            Calculating...
                          </span>
                        )}
                      </div> */}
